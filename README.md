...
Out of the box, Chronas is deployable by serving the `./dist` folder generated by `yarn build`. At this stage of development, Chronas is using a [fake REST api](https://github.com/marmelab/FakeRest) for test data input.
