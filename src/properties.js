...
import customGreekMessages from "./translations/el";
import customRussianMessages from "./translations/ru";
import swedishMessages from "aor-language-swedish";
import japaneseMessages from "aor-language-japanese";
import customFrenchMessages from "./translations/fr";
import customArabicMessages from "./translations/ar";
import italianMessages from "aor-language-italian";
import customDutchMessages from "./translations/nl";
import dutchMessages from "aor-language-dutch";
import customPolishMessages from "./translations/pl";
import greekMessages from "aor-language-greek";
import frenchMessages from "aor-language-french";
import customChineseMessages from "./translations/zh";
import germanMessages from "aor-language-german";
import {englishMessages} from "admin-on-rest";
import spanishMessages from "aor-language-spanish";
import customJapaneseMessages from "./translations/ja";
import customSpanishMessages from "./translations/es";
import customVietnameseMessages from "./translations/vi";
import customSwedishMessages from "./translations/sv";
import arabicMessages from "aor-language-arabic";
import chineseMessages from "aor-language-chinese";
import customItalianMessages from "./translations/it";
...
import customHindiMessages from "./translations/hi";
import customGermanMessages from "./translations/de";
