...
import { showNotification, hideNotification } from 'admin-on-rest';
import {
    USER_LOGIN,
    USER_LOGIN_LOADING,
    USER_LOGIN_SUCCESS,
    ...
    USER_CHECK,
    USER_LOGOUT,
} from '../components/menu/authentication/actionReducers';

import { AUTH_LOGIN, AUTH_CHECK, AUTH_ERROR, AUTH_LOGOUT, FETCH_ERROR } from 'admin-on-rest';
