export default {
  "aor": {
    ...
    "navigation": {
      ...
      "page_out_from_end": "Kann nicht ueber letzte Seite zeigen",
  ...
  "pos": {
    ...
    "block": {
      ...
      "pledge4": "Patreons koennen das Projekt durch Abstimmungen steuern und über neue Funktionalitäten, Prioritäten und wichtige Design-Entscheidungen abstimmen.",
      "pledge5": "Wenn Sie Patreon nicht verwenden moechten, besteht auch die Moeglichkeit einmaliger Spenden via PayPal:",
      "rules1": "<br /> <h4>Regeln Für Data Kuration</h4> <ol> <li><i>Kein Vandalismus</i>: Dies ist nicht der Ort, um zu malen und eine alternative Geschichte zu kreieren. Vandalismus bedroht das gesamte Projekt immens und ist daher verboten. </li> <li><i>Schauen Sie das Tutorialvideo</i> bevor Sie mit der Bearbeitung beginnen. Einige Steuerelemente koennen zu <i>unerwünschten</i> Ergebnisse fuehren. </li> <li>Ihre hinzugefuegten Daten und Bearbeitungen sollte auf <i>gesicherte Geschichte</i> mit enstprechende Quellen basieren. </li></ol> <br /> <h4>Regeln Für Die Foren</h4> <ol> <li><i>Kein Vandalismus</i>: Kein Rassismus, Fanatismus, oder Anstößiges Verhalten.</li> <li>Fragen <i>Stellen Sie klare und spezifische Fragen</i>.</li> <li>Fragen und Antworten sollten in Englisch gestellt werden. </li> </ol>",
      ...
      "support1": "Es gibt ein paar Möglichkeiten, um die Finanzierung, den Unterhalt und die Entwicklung von neuen features und Behebung von Probleme. Zum Beispiel Wikipedia oder die öffentlich-rechtlichen Sendeanstalten verwenden wiederkehrenden Kampagnen, Spenden zu sammeln (<b>Verpfändung Laufwerke</b>), viele web-Anwendungen verwenden <b>Werbung</b> (die Abnahme der Nutzbarkeit/ Genuss der app). Ein anderer Weg ist die Einführung eines <b>pro version</b> oder versuchen Sie es zu finden <b>venture Kapitalanleger</b>.",
      "support10": " den Entwicklern.",
      "support11": "Wenn Sie interessiert sind, Chronas auf Ihrem (oder unserem) server mit einem vollständigen Daten-Replikat, das Sie sind in die vollständige Kontrolle, ",
      "support12": "Kontakt",
      "support13": " uns und wir diskutieren gerne weiter.",
      "support2": "Wir beschlossen zu versuchen, ein weiteres Finanzierungsmodell, das gibt dem <b>Erhaltung Benutzer</b> stellen sicher, dass die Zukunft von Chronas auch die Möglichkeit, zu entscheiden, wo die Reise hingeht. Wenn Sie glauben, in unser Projekt, beachten Sie bitte unterstützt uns auf",
      "support3": " wo haben wir regelmäßige <b>Stimmen</b> auf der Priorität der vorgeschlagenen <b>neuen Funktionen</b> sowie <b>wichtige design-Entscheidungen</b>.",
      "support4": "Wenn Sie keinen Gebrauch von Patreon, einer Zeit, die Beiträge sind per PayPal möglich:",
      "support5": "Neue Features",
      "support6": "Sie können vorschlagen, features in der feature-Anfrage ",
      "support7": "Forum",
      "support8": " oder direkt ",
