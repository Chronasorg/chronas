...
export const LoadingCircle = (props) => {
  ...
  return <div className='LoadingCircle_wrapper'>
    <div className='LoadingCircle_inner'>
      <svg version='1.1' id='LoadingCircle_svg2' style={{ filter: 'drop-shadow(0 0px 2px ' + themes[theme].foreColors[0] + ')' }} className='LoadingCircle_rotate' width='40%' height='40%' viewBox='0 0 4220 4220' preserveAspectRatio='xMidYMid meet'>
