...
// helper function locates points on bezier curves.
  ...
  /*
   ...
   provinceCollection.features[i].properties.Acolor = metadata['political'][tmpCountry][1];
   else {
   ...
   provinceCollection.features[i].properties.Acolor = (metadata['religion'][provinceCollection.features[i].properties.Rel] !== undefined) ? metadata['religion'][provinceCollection.features[i].properties.Rel][1] : undefinedColor;
   }
   break;
      ...
      for (var i = 0; i < provinceCollection.features.length; i++) {  // tmpLength
        ...
        if (areaDefs.hasOwnProperty(tmpProv)) {
          ...
          if (this.activeTextFeat == 'political' && metadata['political'][tmpCountry]) {
            provinceCollection.features[i].properties.nameLabel = metadata['political'][tmpCountry][0]
          } else if (this.activeTextFeat == 'religion' && metadata['religion'][tmpCountry]) {
            provinceCollection.features[i].properties.nameLabel = metadata['religion'][tmpCountry][0]
          }
        }
