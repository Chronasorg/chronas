...
import { activeYear, provinceCollection, provArea, adjacent, rulPlus } from './data/datadef'
...
const utils = {
  ...
  get_polygon_centroid2: function (fullpts) { // need this
    var pts = [];
    for (var j = 0; j < fullpts.length; j++) {
