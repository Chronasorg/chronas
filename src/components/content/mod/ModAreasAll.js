  ...
  return <div>
    ...
    <Create title='Overwrite Area' {...props}>
      <AreaForm validate={validateValueInput} {...props} >
        ...
        />
        <SelectArrayInput options={{ fullWidth: true }} onChange={(val, v) => {
          props.setModData(v)
        ...
        <BooleanInput
          ...
          iconStyle={{ width: 40, height: 40 }}
        />
        <NumberInput style={{ display: 'inline-block', width: 'calc(100% - 100px)' }} source='population'
          defaultValue={+defaultValues.dataPopulation} label='resources.areas.fields.population' />
