...
class TOS extends PureComponent {
  ...
  render() {
    ...
    return (
        <Dialog bodyStyle={{ overflow: 'auto', backgroundImage: themes[theme].gradientColors[0] }} open={true} contentClassName={(this.state.hiddenElement) ? '' : "classReveal"} contentStyle={{transform: '', transition: 'opacity 1s', opacity: 0}} onRequestClose={this.handleClose}>
            ...
            <div>
              ...
              >
                <Tab label='Terms of Service' value='tos' style={{overflow: 'auto'}}>
                  <div>
                    <div><br /></div><div><span style={{whiteSpace: "pre-wrap"}}>										</span></div><div>
                    <h3>ChronasOrg Terms of Service</h3></div><div><br /></div><div>1. Terms</div><div><br /></div><div>&nbsp; By accessing the website at <a href="https://www.chronas.org" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.chronas.org&amp;source=gmail&amp;ust=1544761682344000&amp;usg=AFQjCNEloH0qDGN6RWpjqTuyApoBvWJH_w">https://www.chronas.org</a>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</div><div><br /></div><div>2. Use License</div><div><br /></div><div>&nbsp;&nbsp;</div><div>&nbsp; &nbsp;&nbsp;</div><div>&nbsp; &nbsp; &nbsp; Permission is granted to temporarily download one copy of the materials (information or software) on ChronasOrg's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:</div><div><br /></div><div>&nbsp; &nbsp; &nbsp;&nbsp;</div><div>&nbsp; &nbsp; &nbsp; &nbsp; modify or copy the materials;</div><div>&nbsp; &nbsp; &nbsp; &nbsp; use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</div><div>&nbsp; &nbsp; &nbsp; &nbsp; attempt to decompile or reverse engineer any software contained on ChronasOrg's website;</div><div>&nbsp; &nbsp; &nbsp; &nbsp; remove any copyright or other proprietary notations from the materials; or</div><div>&nbsp; &nbsp; &nbsp; &nbsp; transfer the materials to another person or "mirror" the materials on any other server.</div><div>&nbsp; &nbsp; &nbsp;&nbsp;</div><div>&nbsp; &nbsp;&nbsp;</div><div>&nbsp; &nbsp; This license shall automatically terminate if you violate any of these restrictions and may be terminated by ChronasOrg at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.</div><div>&nbsp;&nbsp;</div><div><br /></div><div>3. Disclaimer</div><div><br /></div><div>&nbsp;&nbsp;</div><div>&nbsp; &nbsp; The materials on ChronasOrg's website are provided on an 'as is' basis. ChronasOrg makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</div><div>&nbsp; &nbsp; Further, ChronasOrg does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.</div><div>&nbsp;&nbsp;</div><div><br /></div><div>4. Limitations</div><div><br /></div><div>&nbsp; In no event shall ChronasOrg or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on ChronasOrg's website, even if ChronasOrg or a ChronasOrg authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</div><div><br /></div><div>5. Accuracy of materials</div><div><br /></div><div>&nbsp; The materials appearing on ChronasOrg's website could include technical, typographical, or photographic errors. ChronasOrg does not warrant that any of the materials on its website are accurate, complete or current. ChronasOrg may make changes to the materials contained on its website at any time without notice. However ChronasOrg does not make any commitment to update the materials.</div><div><br /></div><div>6. History Data</div><div><br /></div><div>&nbsp; ChronasOrg has not reviewed all of the user contributed articles and media linked and is not responsible for the contents of any such linked data. The inclusion of any link does not imply endorsement by ChronasOrg of the site. Use of any such linked items is at the user's own risk.</div><div><br /></div><div>7. Modifications</div><div><br /></div><div>&nbsp; ChronasOrg may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.</div><div><br /></div><div>8. Governing Law</div><div><br /></div><div>&nbsp; These terms and conditions are governed by and construed in accordance with the laws of Wisconsin and you irrevocably submit to the exclusive jurisdiction of the courts in that State or location.</div><div><span style={{ whiteSpace: "pre-wrap"}}>									</span></div></div>
                </Tab>
                  ...
                  >
                    <Tab label='English' value='english' style={{overflow: 'auto'}}>
                      <div role="tabpanel" className="tab-pane  active " id="english">
                        ...
                        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for ChronasOrg is based on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/">Free Privacy Policy Template Website</a>.</p>
                        ...
                        <p>ChronasOrg will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                        <h3>Disclosure Of Data</h3>

                        <h3>Legal Requirements</h3>
                        <p>ChronasOrg may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                    ...
                    <Tab label='Spanish' value='spanish' style={{overflow: 'auto'}}>
                      <div role="tabpanel" className="tab-pane " id="spanish">
                        ...
                        <p>ChronasOrg ("nosotros", "a nosotros", "nuestro") opera el sitio web https://chronas.org (en adelante, el "Servicio").</p>

                        <p>Esta página le informa de nuestras políticas en materia de recopilación, uso y divulgación de datos personales cuando utiliza nuestro Servicio y de las opciones de las que dispone en relación con esos datos. <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/">Plantilla de política de privacidad via FreePrivacyPolicy</a>.</p>

                        <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el https://chronas.org</p>
                        ...
                        <ul>
                          ...
                          <li>Visitando esta página en nuestro sitio web: https://chronas.org/#/info (Contact section)</li>
                    ...
                    <Tab label='French' value='french' style={{overflow: 'auto'}}>
                      <div role="tabpanel" className="tab-pane " id="french">
                        ...
                        <p>ChronasOrg ("nous", "notre", "nos") exploite le site web https://chronas.org (ci-après désigné par le terme "Service").</p>

                        <p>Cette page vous explique nos politiques en matière de collecte, d'utilisation et de communication des données à caractère personnel lorsque vous utilisez notre Service ainsi que les choix qui s'offrent à vous en ce qui concerne ces données. <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/">Modèle de politique de confidentialité via FreePrivacyPolicy</a>.</p>

                        <p>Nous utilisons vos données pour fournir et améliorer le Service. En utilisant le Service, vous consentez à la collecte et à l'utilisation d'informations conformément à la présente politique. Sauf définition contraire dans la présente Politique de Confidentialité, les termes utilisés dans la présente Politique de Confidentialité ont la même signification que dans nos Conditions Générales qui sont disponibles sur https://chronas.org</p>
                        ...
                        <p>Si vous résidez hors de/du United States et que vous choisissez de nous communiquer des informations, sachez que nous transférons les données, y compris les Données à Caractère Personnel, vers le/la United States et que nous les y traitons.</p>
                        ...
                        <ul>
                          ...
                          <li>En consultant cette page sur notre site web: https://chronas.org/#/info (Contact section)</li>
                    ...
                    <Tab label='German' value='german' style={{overflow: 'auto'}}>
                      <div role="tabpanel" className="tab-pane " id="german">
                        ...
                        <p>ChronasOrg ("wir", "uns", "unser" usw.) betreibt die Website https://chronas.org (nachstehend als "Dienst" bezeichnet).</p>

                        <p>Diese Seite enthält Informationen zu der Art und Weise, auf welche wir personenbezogene Daten erfassen, nutzen und offenlegen, wenn Sie unseren Dienst nutzen, sowie zu den Optionen, die Ihnen im Zusammenhang mit diesen Daten zur Verfügung stehen. <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/">Vorlage für die Datenschutzrichtlinie via FreePrivacyPolicy</a>.</p>

                        <p>Wir nutzen Ihre Daten zur Bereitstellung und Verbesserung unseres Dienstes. Durch Inanspruchnahme des Dienstes erklären Sie sich mit der Erfassung und Nutzung von Daten durch uns nach Maßgabe dieser Richtlinie einverstanden. Soweit in dieser Datenschutz-Richtlinie nicht jeweils etwas anderes angegeben ist, kommt den in dieser Datenschutz-Richtlinie vorkommenden Begriffen jeweils dieselbe Bedeutung zu, die diesen in unseren Allgemeinen Geschäftsbedingungen (Terms and Conditions) (abrufbar über die  https://chronas.org) zugewiesen wurde.</p>
                        ...
                        <ul>
                          <li>E-Mail-Adresse</li>    <li>Vorname und Nachname</li>            <li>Cookies und Nutzungsdaten</li>
                        </ul>
                        ...
                        <p>Falls Sie sich außerhalb von United States befinden und sich dazu entscheiden, Daten an uns zu übermitteln, müssen Sie zur Kenntnis nehmen, dass wir Ihre Daten, einschließlich personenbezogener Daten, nach United States übertragen und diese dort verarbeiten.</p>
                        ...
                        <ul>
                          ...
                          <li>Durch Besuch der folgenden Seite unserer Website: https://chronas.org/#/info (Contact section)</li>
                    ...
                    <Tab label='Italian' value='italian' style={{overflow: 'auto'}}>
                      <div role="tabpanel" className="tab-pane " id="italian">
                        ...
                        <p>ChronasOrg ("noi" o "nostro") gestisce il https://chronas.org sito web (in appresso il "Servizio").</p>

                        <p>Questa pagina vi informa delle nostre politiche riguardanti la raccolta, l'uso e la divulgazione dei dati personali quando usate il nostro Servizio e le scelte che avete associato a quei dati. <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/">Modello di politica sulla privacy via FreePrivacyPolicy</a>.</p>

                        <p>Utilizziamo i vostri dati per fornire e migliorare il Servizio. Utilizzando il Servizio, accettate la raccolta e l'utilizzo delle informazioni in conformità con questa informativa. Se non diversamente definito nella presente Informativa sulla privacy, i termini utilizzati nella presente Informativa hanno la stessa valenza dei nostri Termini e condizioni, accessibili da https://chronas.org</p>
                        ...
                        <p>Se ci si trova al di fuori di United States e si sceglie di fornire informazioni a noi, si ricorda che trasferiamo i dati, compresi i dati personali, in United States e li elaboriamo lì.</p>
                        ...
                        <ul>
                          ...
                          <li>Visitando questa pagina sul nostro sito web: https://chronas.org/#/info (Contact section)</li>
                    ...
                    <Tab label='Dutch' value='dutch' style={{overflow: 'auto'}}>
                      <div role="tabpanel" className="tab-pane " id="dutch">
                        ...
                        <p>ChronasOrg ("ons", "wij" of "onze") beheert de https://chronas.org website ("hierna genoemd Dienst").</p>

                        <p>Deze pagina bevat informatie over ons beleid met betrekking tot de verzameling, het gebruik en de openbaarmaking van uw persoonsgegevens wanneer u onze Dienst gebruikt en de keuzes die u hebt met betrekking tot die gegevens. <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/">Privacybeleid sjabloon via FreePrivacyPolicy</a>.</p>

                        <p>Wij gebruiken uw gegevens om de Dienst te leveren en te verbeteren. Wanneer u de Dienst gebruikt, gaat u akkoord met de verzameling en het gebruik van informatie in overeenstemming met dit beleid. Tenzij anders bepaald in dit Privacybeleid heeft de terminologie die wordt gebruikt in dit Privacybeleid dezelfde betekenis als in onze Algemene voorwaarden, beschikbaar op https://chronas.org</p>
                        ...
                        <p>Let erop dat, als u zich buiten United States bevindt en u ons gegevens verstrekt, wij deze gegevens, inclusief Persoonsgegevens, overdragen naar United States en ze daar verwerken.</p>
                        ...
                        <p>ChronasOrg zal alle redelijkerwijs noodzakelijke stappen ondernemen om ervoor te zorgen dat uw gegevens veilig en in overeenstemming met dit Privacybeleid worden behandeld en dat uw Persoonsgegevens nooit worden overgedragen aan een organisatie of een land als er geen gepaste controles zijn ingesteld, inclusief de veiligheid van uw gegevens en andere persoonsgegevens.</p>

                        <h3>Openbaarmaking van gegevens</h3>

                        <h3>Wettelijke vereisten</h3>
                        <p>ChronasOrg kan uw Persoonsgegevens openbaar maken als het te goeder trouw de mening is toegedaan dat een dergelijke handeling noodzakelijk is:</p>
                        <ul>
