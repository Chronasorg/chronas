  ...
  render () {
    ...
    return <Switch>
      <Route exact path="/community/admin" render={restrictPage(AdminContainer, {
        ...
        {/*<NavLink to='/community/admin' component={AdminDashboard} />*/}
      </Route>
