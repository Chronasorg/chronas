...
export const fetchDiscussions = (forum_slug, sortingMethod, qEntity = '') => { // ${qEntity}
  return axios.get(properties.chronasApiHost + '/board/forum/' + forum_slug + '/discussions?sorting_method=' + sortingMethod + (qEntity ? ('&q=' + qEntity) : ''), { 'headers': { 'Authorization': 'Bearer ' + localStorage.getItem('chs_token')}});
};
