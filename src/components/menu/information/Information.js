          ...
          >
            ...
            <Tab label={translate('pos.info.tabs.contact')} value='contact'>
              ...
              <div className=''>
                ...
                <br />
                <p>
                  {translate('pos.block.contact4')} <a className='customLink' target='_blank' href='http://twitter.com/vorontsovie'>Ilya Vorontsov</a> (Russian), Michel Gansmann (French), Dietmar Aumann (German), ...</p>
                <br />
