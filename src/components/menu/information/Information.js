          ...
          >
            <Tab label='Welcome' value='welcome'>
              ...
              <div className='modal-header'>
                <h4 className='modal-title' style={{ fontSize: 33, margin: '0 auto' }}>Welcome to <ChronasLogo height={50}
                  vheight={360}
                  width={160}
                  vwidth={1000}
              ...
              <div style={{
                ...
                <p>
                  <span style={{ fontWeight: 800 }}>Chronas</span> is a history map application with over <a
                    className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => this.handleChange('statistics')}>50 million data points</a> which every registered user
                  can curate and contribute to (just like <a>Wikipedia</a>).
                </p>
                <p>
                  Before you dive in, make sure to watch the short <a className='customLink' style={{
                    fontWeight: 800,
                    color: themes[theme].highlightColors[0]
                  }} onClick={() => this.handleChange('tutorial')}>Tutorial Video</a> in the How To section.
                </p>
                <p>
                  <a className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => history.push('/login')}>Join</a> our community of <span
                      style={{ fontWeight: 800 }}>{welcomeStatistics ? welcomeStatistics.user : '...'}</span> members to add
                  and edit data, earn points, ask questions about history articles and access our <a
                    className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => history.push('/community/general')}>Forums</a> to suggest new features and report bugs.
                </p>
                <p>Visit the <a className='customLink'
                  style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                  onClick={() => this.handleChange('about')}>About</a> section to read more about the
                  Chronas project and send the developers your inquiries, comments or questions through the <a
                    className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => this.handleChange('contact')}>Contact</a> form.</p>
                <p>We believe in the potential of this project to become a popular history tool alongside Wikipedia. If
                  you share our enthusiasm and want to see the project succeed, please consider becoming a sustainer.
                  For more information on <b>support</b> and the <b>future of Chronas</b>, visit the <a
                    className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => this.handleChange('pro')}>New Features</a> section.</p>
                <div style={{
                  zIndex: 2,
                ...
                <div className='nofocus' style={{
                  ...
                  <div className='signup-button'><a href={'https://twitter.com/Chronasorg'} target={'_blank'}
                    ...
                    className='btn btn-link-twitter btn-block'><i
                      className='fa fa-twitter-square' /><span className=''>  Follow us on Twitter</span></a></div>
                </div>
                <div className='nofocus' style={{
                  position: 'absolute',
                  bottom: 14,
                  ...
                  <div className='signup-button'><a href={'https://www.facebook.com/chronasorg'} target={'_blank'}
                    ...
                    className='btn btn-link-facebook btn-block'><i
                      className='fa fa-facebook-square' /><span className=''>  Follow us on Facebook</span></a></div>
                </div>
                ...
                {welcomeStatistics && <div style={{
                  ...
                  bottom: 18,
                  fontSize: 'small'
                }}>last data edit {welcomeStatistics.lastDataEdit}</div>}
              </div>
            </Tab>
            ...
            <Tab label='About' value='about'>
              ...
              <div>
                ...
                <br />
                <h5>In Brief</h5>
                <p>Chronas may be described as a mix of <a target='_blank' href='https://www.openstreetmap.org'>Open
                  Street Map</a>, <a target='_blank' href='https://www.wikipedia.org/'>Wikipedia</a> and <a
                  ...
                  be found <a className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => this.handleChange('tutorial')}>here</a>.</p>
                ...
                <p>You can find a detailed feature walkthrough of the new Chronas version in the <a
                  className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                  onClick={() => this.handleChange('tutorial')}>How To</a> section.</p>
            ...
            <Tab label='Statistics' value='statistics'>
              ...
              <div>
                <br />
                <p><i>The following statistics are live data counts and represent a snapshot of the current Chronas
                  database</i></p>
                <br />
            ...
            <Tab label='Support' style={{ color: themes[theme].highlightColors[0] }} value='pro'>
              ...
              <div className=''>
                ...
                <h4>Support</h4>
                <p>
                  There are a couple of ways to finance the upkeep and the development of new features and fixing of
                ...
                <br />
                <h4>New Features</h4>
                <p><b>You can propose features in the feature request <a className='customLink' style={{
                  fontWeight: 800,
                  color: themes[theme].highlightColors[0]
                }} onClick={() => history.push('/community/features')}>forum</a> or by directly <a
                  className='customLink' style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                  onClick={() => this.handleChange('contact')}>contacting</a> the developers.</b> Accepted features will
                  be listed here.</p>
                <ul>
                  <li>New dimension <b>General Ruler</b>: Similar to general religions, it may make sense to have
                    optional general rulers to be able to show umbrella entities like the ancient <b>Delian League</b>,
                    the medieval <b>Holy Roman Empire</b> or the modern <b>European Union</b>. This new dimension will
                    be a new option next to already existing ones <i>(Ruler, Culture, Religion, General Religion)</i>.
                  </li>
                  <li><b>Article lists and collections</b>: Users can create article lists containing any article types
                    (marker, area, media or epics), name them and optional share them with the community.
                  </li>
                  <li><b>Bookmarks and History</b>: Users can bookmark and write notes on selected articles which only
                    they can see. Also, any article which is viewed by the user will be marked as read and a counter of
                    read articles is incremented - if a user visits the same article again it will display the time and
                    date this artilce was last viewed.
                  </li>
                  <li><b>Full database search</b>: Free text search and filters available to find and browse any article
                    in our database
                  </li>
                  <li><b>Managed accounts</b>: This feature allows users to create and manage accounts with limited
                    scope (such as limiting the managed users to a selection of markers and time ranges) as well as
                    viewing articles read by the managed user accounts (classroom setting)
                  </li>
                  <li><b>Full localisation</b>: Chronas in a different language will not only support a complete GUI
                    translation but will also be viewing the articles in its according Wikipedia subsite
                  </li>
                ...
                <br />
                <p>
                  If you are interested in running Chronas on your (or our) server with a complete data replica of which
                  you are in complete control, <a className='customLink'
                    style={{ fontWeight: 800, color: themes[theme].highlightColors[0] }}
                    onClick={() => this.handleChange('contact')}>contact</a> us and we are
            ...
            <Tab label='Contact' value='contact'>
              ...
              <div className=''>
                ...
                <br />
                <h4>Contact</h4>
                <p>Send us an email directly (hover over the email icon to display our email addresses) or use the form
                  below:</p>
                <Paper zDepth={2}>
